            ...
            <div class="col-lg-12">
                <div class="ibox ">
                    <div class="ibox-title ibox-title-border">
                        <h5 class="float-left">Tag List</h5>
                        <a class="btn btn-primary btn-xs float-right" href="tag/create"><i class="fa fa-plus"></i> Add New</a>
                    </div>
       ...
       <script>
           $(document).ready(function(){
               $('.dataTables-list').DataTable({
                   ...
                   columns: [
                   {data: 'title',orderable: true},{data: 'description',orderable: true},{data: 'status',orderable: true},
