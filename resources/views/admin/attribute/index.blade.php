            ...
            <div class="col-lg-12">
                <div class="ibox ">
                    <div class="ibox-title ibox-title-border">
                        <h5 class="float-left">attribute List</h5>
                        <a class="btn btn-primary btn-xs float-right" href="attribute/create"><i class="fa fa-plus"></i> Add New</a>
                    </div>
                    <div class="ibox-content ibox-content-custom">
                        @include('admin.attribute.partials.table')
       ...
       <script>
           $(document).ready(function(){
               $('.dataTables-list').DataTable({
                   ...
                   columns: [
                    {data: 'type',orderable: true},{data: 'name',orderable: true},{data: 'desc',orderable: true},{data: 'status',orderable: true},
