                ...
                <div class="col-lg-5 col-md-12 col-12">
                    ...
                    <div class="top-left">
                        <ul class="list-main">
                            ...
                            <li><i class="ti-email"></i> {{ $settings['0']->site_email }}</li>
                        </ul>
                    </div>
                    <!--/ End Top Left -->
                </div>
                <div class="col-lg-7 col-md-12 col-12">
                    ...
                    <div class="right-content">
                        <ul class="list-main">
                            ...
                            @guest
                                <li><i class="ti-user"></i> <a href="/new-login">My account</a></li>
                                <li><i class="ti-power-off"></i><a href="/new-login">Login</a></li>
                            @else

                                <li><i class="ti-user"></i> <a href="/admin">My account</a></li>
